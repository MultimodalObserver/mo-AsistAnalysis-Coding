...
import controller.LabelTextViewController;
...
public class CodingManagement implements IMenuBarItemProvider {
    ...
    public LabelTextViewController ct = new LabelTextViewController();
    ...
    CodingManagement am;//Para swing

    public CodingManagement(String nombre) {

          //System.out.println("Nombre aca nuevo");

    }

    public void set_TranscriptionManagement(CodingManagement am){
          this.am = am;
    }
...
//  }
  ...
  public void setController(LabelTextViewController cc){
      ct = cc;
  
  }
  
  
  public LabelTextViewController get_Controller(){
  ...
  public Parent getFXMLLoader(){
    ...
    loaderui2.setController(ct);
        ...
        try {
            ...
            Logger.getLogger(CodingManagement.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  public Parent initFxml() {
        ...
        try {
            ...
            FXMLLoader loaderui2 = new FXMLLoader(getClass().getResource("/view/ClougTagsAsistAnalysis.fxml"));
            LabelTextViewController am = new LabelTextViewController();
