 ...
 * @author Lathy
 */
public class CodingConfiguration implements PlayableAnalyzableConfiguration  {
    ...
    private List<CodingVisualization> playables;
    private List<CodingVisualization> visualizables;
    
    private static final Logger logger = Logger.getLogger(CodingConfiguration.class.getName());
    ...
    public CodingConfiguration(String name) {
    ...
    public void addPlayable(CodingVisualization playable) {
        playables.add(playable);
    }

    public void addVisualizable(CodingVisualization visualizable) {
    ...
    public File toFile(File parent) {
        File f = new File(parent, "coding"+id+".xml");
        try {
            f.createNewFile();
    ...
    public Configuration fromFile(File file) {
        ...
        if (fileName.contains("_") && fileName.contains(".")) {
            ...
            CodingConfiguration config = new CodingConfiguration ();
            config.id = name;
            return config;
        }
        return null;
